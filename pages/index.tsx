  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Stake your ADA with Cardano Fans pool. Only 1.99% fees, 100k pledge, 99.9% uptime. Professional operators with 15+ years experience. Join 1000+ delegators today!" />
        ...
        <meta property="og:description" content="Professional Cardano staking pool with 1.99% fees, 100k ADA pledge, and 15+ years server management experience." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Professional Cardano staking pool with 1.99% fees, 100k ADA pledge, and 15+ years server management experience.",
              "founder": {
                "@type": "Person",
                "name": "Mati Winnetou"
              },
